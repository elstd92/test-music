package com.elstudio.inc.appthemehelper.util
...
object TextInputLayoutUtil {
    ...
    fun setHint(view: TextInputLayout, @ColorInt hintColor: Int) {
        try {
            ...
            throw RuntimeException(
                "Failed to set TextInputLayout hint (collapsed) color: " + t.localizedMessage,
                t
            )
        }
    ...
    fun setAccent(view: TextInputLayout, @ColorInt accentColor: Int) {
        try {
            ...
            throw RuntimeException(
                "Failed to set TextInputLayout accent (expanded) color: " + t.localizedMessage,
                t
            )
        }
