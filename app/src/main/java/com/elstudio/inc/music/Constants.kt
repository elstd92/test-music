...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=com.el.studio.music"
    const val TRANSLATE = "http://monkeycodeapp.oneskyapp.com/collaboration/project?id=238534"
    const val GITHUB_PROJECT = "https://github.com/elstd92/test-music"
    ...
    const val FAQ_LINK = "https://github.com/elstd92/test-music/blob/master/FAQ.md"
