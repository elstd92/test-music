package com.elstudio.inc.music.activities.tageditor
...
abstract class AbsTagEditorActivity : AbsBaseActivity() {
    ...
    private fun setUpImageView() {
        loadCurrentImage()
        items = listOf(
            getString(com.elstudio.inc.music.R.string.pick_from_local_storage),
            getString(com.elstudio.inc.music.R.string.web_search),
            getString(com.elstudio.inc.music.R.string.remove_cover)
        )
